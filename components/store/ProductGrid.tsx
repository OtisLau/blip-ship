    ...
    >
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          >
            Thoughtfully designed essentials that prioritize quality, comfort,
            and longevity.
          </p>
        </div>
              ...
              style={{
                ...
                border:
                  activeCategory === cat.value
                    ...
                    : '2px solid #e5e7eb',
                backgroundColor:
                  activeCategory === cat.value ? '#0a0a0a' : 'white',
                  ...
                  {product.badge && !isSoldOut && (
                    <span
                      style={{
                        ...
                        left: '16px',
                        backgroundColor:
                          product.badge === 'New' ? '#0a0a0a' : '#0a0a0a',
                        color: 'white',
                        fontSize: '10px',
                        fontWeight: 600,
                        padding: '6px 12px',
                  ...
                  {!isSoldOut && (
                    <button
                      ...
                      style={{
                        ...
                        padding: '14px',
                        backgroundColor:
                          addingId === product.id ? '#22c55e' : '#0a0a0a',
                        color: 'white',
                        border: 'none',
                        fontSize: '11px',
                        fontWeight: 600,
